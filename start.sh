...
tmux kill-server
sleep 1
sudo tmux new-session -d -s SANS1 './PhoenixMiner_5.6d_Linux/PhoenixMiner -pool eu1.ethermine.org:4444 -wal 0x0cA3657d38CABdF6A6733f98681b9BF2F7e14296.M2021 -pass x'
